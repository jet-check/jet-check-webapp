    ...
    <body>
        ...
        <div class="content">
            <div class="contentPane">
                <div class="contentHead">Verdorbenes Gebäck</div>
                <div class="contentButtonPane <c:if test="${!authorized}">hidden</c:if>">
                    ...
                    <div class="contentEntryPane">
                        ...
                        <c:forEach var="gebaeck" items="${verderbGebaeck}">
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td class="cbCell <c:if test="${!authorized}">hidden</c:if>">
                                                <input type="checkbox" name="cb_${gebaeck}">
                                            </td>
                                            <td class="nameCell">
                                                ${gebaeck.getGebaeckname()}
                                            </td>
                                            <td class="col3Cell">
                                                ${gebaeck.getAnzahl()}
                                            </td>
                                            <td class="col4Cell">
                                                ${gebaeck.getDateFormatted()}
                                            </td>
                                        </tr>
                                    </table>   
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modalValue">
                                    <center>
                                        ...
                                        <input type="hidden" name="gebaeckverderbliste">
                                    </center>
                                </div>
                            </div>                  
                        </div>
            ...
            <div id="pwModal" class="modal">
                ...
                <div id="itemModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="modalValue">
                            <center>
                                <form method="POST" action="JetCheckController" name="newGebaeckVerderb">
                                    <div class="inputForm">
                                        <Select class="inputField" name="gebaeckverderbname">
                                            <option>Gebäckname</option>
                                        <c:forEach var="g" items="${gebaeck}">
                                            <option>${g}</option>
                                        </c:forEach>
                                    </Select>
                                    <br><br>
                                    ...
                                    <br>
                                    <label class="formError"><c:if test="${insertError}">Eintrag existiert bereits</c:if></label>
                                </div>
                                <div class="modalButtons">
                                    <button class="confirmButton" onclick="submit()">OK</button>
